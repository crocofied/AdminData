...
function Navbar() {
    return (
      <div className="navbar bg-base-200 shadow-lg w-24 h-screen">
            <div className="container mx-auto flex flex-col justify-between h-full">
                <div className="flex-none">
                    <ul className="menu menu-vertical px-1">
                        <li>
                            <Link to="/dashboard" className="bg-stone-900 text-white px-4 py-4 rounded-2xl mb-4">
                            ...
                            <Link to="/settings" className="bg-stone-900 text-white px-4 py-4 rounded-2xl">
                ...
                <div className="flex-none">
                    <ul className="menu menu-vertical px-1">
                        <li><Link to="/logout" className="bg-stone-900 text-white px-4 py-4 rounded-2xl">
